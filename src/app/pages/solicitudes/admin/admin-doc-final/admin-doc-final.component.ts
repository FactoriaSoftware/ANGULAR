...
@Component({
  ...
  templateUrl: './admin-doc-final.component.html',
  styleUrls: ['./admin-doc-final.component.css']
})
export class AdminDocFinalComponent implements OnInit {
...
//-----Estudiante Principal-------//
    ...
    Swal.fire({
      ...
      if (result.value) {
        ...
        let solicitud = new Solicitud (null,null,null,null,null,null,null,null,null,null,null,null,null,null,
          null,null,this.tutor_id,null,this.estado_anteproyecto,null,null,this.estado_proyecto,null,null,form.value.estado_documento_final,null,form.value.notas,"Aprobada")
  ...
  getDataInfo(data: any) {
    ...
    this.estado_documento_final =data.estado_documento_final;
